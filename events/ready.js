...
**Описание:** \n\`${data.motd.clean[0] + data.motd.clean[1]}\``)
        ...
        const statuses = [
            ...
            `Спасибо ${bot.users.cache.get('600213322444308481').tag}, ${bot.users.cache.get('500638624837140484').tag} и ${bot.users.cache.get('597854685457678338').tag} за донат ❤`
        ];
        setInterval(() => {
